local ts = require("vogsphere.treesitter")
...
function M.invert_color(color)
  local hsluv = require("vogsphere.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("vogsphere", { clear = true })
...
function M.terminal(colors)
  ...
  vim.g.terminal_color_6 = colors.grey
  vim.g.terminal_color_14 = colors.grey
end
