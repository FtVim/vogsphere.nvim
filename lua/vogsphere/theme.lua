...
local colors = require("vogsphere.colors")
...
function M.setup()
  ...
  theme.highlights = {
    ...
    Conceal = { fg = c.blue100 }, -- placeholder characters substituted for concealed text (see 'conceallevel')
    ...
    Directory = { fg = c.blue100 }, -- directory names (and other special names in listings)
    DiffAdd = { fg = c.blue500, bg = c.base02, bold = true }, -- diff mode: Added line |diff.txt|
    DiffChange = { fg = c.blue700, bg = c.base02, bold = true }, -- diff mode: Changed line |diff.txt|
    DiffDelete = { fg = c.red500, bg = c.base02, bold = true }, -- diff mode: Deleted line |diff.txt|
    DiffText = { fg = c.blue100, bg = c.base02, bold = true }, -- diff mode: Changed text within a changed line |diff.txt|
    ...
    LineNr = { fg = c.blue500, bg = options.transparent and c.none or c.bg }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr = { fg = c.blue300, sp = c.base1 }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    MatchParen = { fg = c.blue100, bg = c.blue500, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ModeMsg = { fg = c.blue100 }, -- 'showmode' message (e.g., "-- INSERT -- ")
    MsgArea = { fg = c.base2 }, -- Area for messages and cmdline
    -- MsgSeparator= { }, -- Separator for scrolled messages, `msgsep` flag of 'display'
    MoreMsg = { fg = c.blue100 }, -- |more-prompt|
    ...
    Pmenu = { fg = c.base0, bg = c.bg }, -- Popup menu: normal item.
    PmenuSel = { fg = c.base01, bg = c.bg, reverse = true }, -- Popup menu: selected item.
    ...
    Question = { fg = c.green100, bold = true }, -- |hit-enter| prompt and yes/no questions
    ...
    Search = { fg = c.blue700, reverse = true }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    IncSearch = { fg = c.blue300, standout = true }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    ...
    SpellCap = { sp = c.blue500, undercurl = true }, -- Word that should start with a capital. |spell| Combined with the highlighting used otherwise.
    SpellLocal = { sp = c.green100, undercurl = true }, -- Word that is recognized by the spellchecker as one that is used in another region. |spell| Combined with the highlighting used otherwise.
    SpellRare = { sp = c.blue700, undercurl = true }, -- Word that is recognized by the spellchecker as one that is hardly ever used.  |spell| Combined with the highlighting used otherwise.
    ...
    TabLineSel = { fg = c.blue700, bg = c.bg }, -- tab pages line, active tab page label
    Title = { fg = c.blue300, bold = true }, -- titles for output from ":set all", ":autocmd" etc.
    ...
    WarningMsg = { fg = c.blue300, bold = true }, -- warning messages
    ...
    Statement = { fg = c.blue500 }, -- (preferred) any statement
    -- Conditional   = { }, --  if, then, else, endif, switch, etc.
    -- Repeat        = { }, --   for, do, while, etc.
    -- Label         = { }, --    case, default, etc.
    Operator = { fg = c.blue500 }, -- "sizeof", "+", "*", etc.
    Keyword = { fg = c.blue500, style = options.styles.keywords }, --  any other keyword
    -- Exception     = { }, --  try, catch, throw

    PreProc = { fg = c.blue500 }, -- (preferred) generic Preprocessor
    -- Include       = { }, --  preprocessor #include
    -- Define        = { }, --   preprocessor #define
    -- Macro         = { }, --    same as Define
    -- PreCondit     = { }, --  preprocessor #if, #else, #endif, etc.

    Type = { fg = c.blue300 }, -- (preferred) int, long, char, etc.
    -- StorageClass  = { }, -- static, register, volatile, etc.
    -- Structure     = { }, --  struct, union, enum, etc.
    -- Typedef       = { }, --  A typedef

    Special = { fg = c.blue300 }, -- (preferred) any special symbol
    -- SpecialChar   = { }, --  special character in a constant
    -- Tag           = { }, --    you can use CTRL-] on this
    -- Delimiter     = { }, --  character that needs attention
    -- SpecialComment= { }, -- special things inside a comment
    Debug = { fg = c.blue300 }, --    debugging statements
    ...
    Todo = { fg = c.blue500, bold = true }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX

    qfLineNr = { fg = c.base0 },
    qfFileName = { fg = c.blue500 },

    htmlH1 = { fg = c.blue500, bold = true },
    htmlH2 = { fg = c.blue100, bold = true },

    -- mkdHeading = { fg = c.orange, bold = true },
    mkdCode = { bg = c.green900 },
    mkdCodeDelimiter = { fg = c.base0, bg = c.green700 },
    mkdCodeStart = { fg = c.blue300, bold = true },
    mkdCodeEnd = { fg = c.blue300, bold = true },
    -- mkdLink = { fg = c.blue, underline = true },

    markdownHeadingDelimiter = { fg = c.blue300, bold = true },
    markdownCode = { fg = c.blue700, bg = c.green900 },
    markdownCodeBlock = { fg = c.blue700, bg = c.green900 },
    markdownH1 = { fg = c.blue500, bold = true },
    markdownH2 = { fg = c.blue500, bold = true },
    markdownLinkText = { fg = c.blue100, underline = true },

    ["helpCommand"] = { fg = c.blue100, bg = c.blue900 },
    ...
    DiagnosticWarn = { fg = c.yellow500 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default
    ...
    DiagnosticVirtualTextWarn = { bg = c.yellow700, fg = c.grey100 }, -- Used for "Warning" diagnostic virtual text
    DiagnosticVirtualTextInfo = { bg = c.blue900, fg = c.blue100 }, -- Used for "Information" diagnostic virtual text
    DiagnosticVirtualTextHint = { bg = c.grey900, fg = c.green100 }, -- Used for "Hint" diagnostic virtual text
    ...
    ["@operator"] = { fg = c.blue500 }, -- For any operator: `+`, but also `->` and `*` in C.

    --- Punctuation
    ["@punctuation.delimiter"] = { fg = c.blue500 }, -- For delimiters ie: `.`
    ["@punctuation.bracket"] = { fg = c.blue300 }, -- For brackets and parens.
    ["@punctuation.special"] = { fg = c.blue300 }, -- For special punctutation that does not fall in the catagories before.
    ["@punctuation.special.markdown"] = { fg = c.blue300, bold = true },
    ["@markup.list"] = { fg = c.blue100 }, -- For special punctutation that does not fall in the catagories before.
    ["@markup.list.markdown"] = { fg = c.blue300, bold = true },

    --- Literals
    ["@string.documentation"] = { fg = c.green100 },
    ["@string.regexp"] = { fg = c.grey300 }, -- For regexes.
    ["@string.escape"] = { fg = c.green300 }, -- For escape characters within a string.

    --- Functions
    ["@constructor"] = { fg = c.blue300 }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ["@variable.parameter"] = { fg = c.blue300 }, -- For parameters of a function.
    ["@variable.parameter.builtin"] = { fg = c.yellow300 }, -- For builtin parameters of a function, e.g. "..." or Smali's p[1-99]

    --- Keywords
    ["@keyword"] = { fg = c.blue500, style = options.styles.keywords }, -- For keywords that don't fall in previous categories.
    ["@keyword.function"] = { fg = c.blue500, style = options.styles.functions }, -- For keywords used to define a fuction.

    ["@label"] = { fg = c.blue500 }, -- For labels: `label:` in C and `:label:` in Lua.

    --- Types
    ["@type.builtin"] = { link = "Type" },
    ["@variable.member"] = { fg = c.green100 }, -- For fields.
    ["@property"] = { link = "Identifier" },

    --- Identifiers
    ["@variable"] = { fg = c.base0, style = options.styles.variables }, -- Any variable name that does not have another highlight.
    ["@variable.builtin"] = { fg = c.blue300 }, -- Variable names that are defined by the languages, like `this` or `self`.
    ["@module.builtin"] = { fg = c.blue300 }, -- Variable names that are defined by the languages, like `this` or `self`.

    --- Text
    -- ["@markup.raw.markdown"] = { fg = c.blue },
    ["@markup.raw.markdown_inline"] = { fg = c.blue700, bg = c.green900 },
    ["@markup.link"] = { fg = c.blue100, underline = true },

    ["@markup.list.unchecked"] = { fg = c.blue700 }, -- For brackets and parens.
    ["@markup.list.checked"] = { fg = c.blue500 }, -- For brackets and parens.
    ...
    -- tsx
    ["@constructor.tsx"] = { fg = c.blue100 },
    ["@tag.delimiter.tsx"] = { fg = c.blue300 },
    ["@tag.tsx"] = { fg = c.blue700 },
    ["@keyword.return.tsx"] = { fg = c.blue500, style = "italic" },
    ["@keyword.tsx"] = { fg = c.blue500, style = "italic" },

    -- typescript
    ["@variable.typescript"] = { fg = c.blue700 },

    -- Vue
    ["@tag.delimiter.vue"] = { fg = c.blue300 },

    -- html
    ["@tag.delimiter.html"] = { fg = c.blue300 },

    -- javascriptreact
    ["@keyword.javascript"] = { fg = c.blue500, style = "italic" },
    ["@keyword.return.javascript"] = { fg = c.blue500, style = "italic" },
    ["@tag.delimiter.javascript"] = { fg = c.blue300 },
    ["@tag.javascript"] = { fg = c.blue700 },
    ["@variable.javascript"] = { fg = c.blue700 },
    ...
    ["@lsp.type.interface"] = { fg = c.blue100 },
    ...
    ["@lsp.typemod.type.defaultLibrary"] = { fg = c.blue100 },
    ["@lsp.typemod.typeAlias.defaultLibrary"] = { fg = c.blue100 },
    ...
    rainbowcol2 = { fg = c.blue300 },
    rainbowcol3 = { fg = c.blue700 },
    rainbowcol4 = { fg = c.blue500 },
    rainbowcol5 = { fg = c.green100 },
    rainbowcol6 = { fg = c.blue100 },
    rainbowcol7 = { fg = c.blue500 },
    ...
    TSRainbowblue = { fg = c.blue500 },
    TSRainbowgrey = { fg = c.grey },
    ...
    RainbowDelimiterblue = { fg = c.blue },
    RainbowDelimitergrey = { fg = c.grey },

    -- LspTrouble
    TroubleText = { fg = c.base0 },
    TroubleCount = { fg = c.blue500 },
    TroubleNormal = { fg = c.base0 },

    -- Illuminate
    illuminatedWord = { bg = c.blue900 },
    illuminatedCurWord = { bg = c.blue900 },
    IlluminatedWordText = { bg = c.blue900 },
    IlluminatedWordRead = { bg = c.blue900 },
    IlluminatedWordWrite = { bg = c.blue900 },

    -- diff
    diffAdded = { fg = c.blue500 },
    diffRemoved = { fg = c.red500 },
    diffChanged = { fg = c.blue700 },
    diffOldFile = { fg = c.blue500 },
    diffNewFile = { fg = c.blue300 },
    diffFile = { fg = c.blue100 },
    diffLine = { fg = c.base01 },
    diffIndexLine = { fg = c.blue500 },

    -- Neogit
    NeogitBranch = { fg = c.blue500 },
    NeogitRemote = { fg = c.blue500 },
    NeogitHunkHeader = { fg = c.base0, bg = c.base02 },
    NeogitHunkHeaderHighlight = { fg = c.blue100, bg = c.base02 },
    NeogitDiffContextHighlight = { fg = c.base00, bg = c.base02 },
    NeogitDiffDeleteHighlight = { fg = c.red500, bg = c.red900 },
    NeogitDiffAddHighlight = { fg = c.blue500, bg = c.green900 },

    -- Neotest
    NeotestPassed = { fg = c.blue500 },
    NeotestRunning = { fg = c.blue700 },
    NeotestFailed = { fg = c.red500 },
    NeotestSkipped = { fg = c.blue100 },
    NeotestTest = { fg = c.base00 },
    NeotestNamespace = { fg = c.green100 },
    NeotestFocused = { fg = c.blue700 },
    NeotestFile = { fg = c.green100 },
    NeotestDir = { fg = c.blue100 },
    NeotestBorder = { fg = c.blue100 },
    NeotestIndent = { fg = c.base00 },
    NeotestExpandMarker = { fg = c.base0 },
    NeotestAdapterName = { fg = c.blue500, bold = true },
    NeotestWinSelect = { fg = c.blue100 },
    NeotestMarked = { fg = c.blue100 },
    NeotestTarget = { fg = c.blue100 },
    --[[ NeotestUnknown = {}, ]]

    -- GitGutter
    GitGutterAdd = { fg = c.blue500 }, -- diff mode: Added line |diff.txt|
    GitGutterChange = { fg = c.blue700 }, -- diff mode: Changed line |diff.txt|
    GitGutterDelete = { fg = c.red500 }, -- diff mode: Deleted line |diff.txt|
    GitGutterAddLineNr = { fg = c.blue500 },
    GitGutterChangeLineNr = { fg = c.blue700 },
    GitGutterDeleteLineNr = { fg = c.red500 },

    -- GitSigns
    GitSignsAdd = { fg = c.blue500 }, -- diff mode: Added line |diff.txt|
    GitSignsChange = { fg = c.blue700 }, -- diff mode: Changed line |diff.txt|
    ...
    -- NvimTree
    NvimTreeNormal = { fg = c.base00, bg = c.bg },
    NvimTreeWinSeparator = {
      fg = options.styles.sidebars == "transparent" and c.border or c.bg_sidebar,
      bg = c.bg,
    },
    NvimTreeNormalNC = { fg = c.base00, bg = c.bg },
    NvimTreeRootFolder = { fg = c.blue, bold = true },
    NvimTreeGitDirty = { fg = c.blue700 },
    NvimTreeGitNew = { fg = c.blue500 },
    NvimTreeGitDeleted = { fg = c.red500 },
    NvimTreeOpenedFile = { bg = c.bg_highlight },
    NvimTreeSpecialFile = { fg = c.blue500, underline = true },
    ...
    DashboardKey = { fg = c.blue300 },
    DashboardDesc = { fg = c.green100 },
    DashboardIcon = { fg = c.green100, bold = true },
    ...
    LspSagaBorderTitle = { fg = c.grey },
    LspSagaHoverBorder = { fg = c.bg },
    LspSagaRenameBorder = { fg = c.green },
    LspSagaDefPreviewBorder = { fg = c.green },
    LspSagaCodeActionBorder = { fg = c.blue },
    LspSagaFinderSelection = { fg = c.base03 },
    LspSagaCodeActionTitle = { fg = c.grey },
    LspSagaCodeActionContent = { fg = c.blue500 },
    LspSagaSignatureHelpBorder = { fg = c.red },
    ReferencesCount = { fg = c.blue500 },
    DefinitionCount = { fg = c.blue500 },
    DefinitionIcon = { fg = c.blue },
    ReferencesIcon = { fg = c.blue },
    TargetWord = { fg = c.green100 },

    -- NeoVim
    healthError = { fg = c.error },
    healthSuccess = { fg = c.grey },
    ...
    BufferInactive = { bg = util.darken(c.bg_highlight, 0.4), fg = util.darken(c.blue500, 0.8) },
    ...
    BufferInactiveIndex = { bg = util.darken(c.bg_highlight, 0.4), fg = c.blue500 },
    ...
    BufferOffset = { bg = c.bg_statusline, fg = c.blue500 },
    BufferTabpageFill = { bg = util.darken(c.bg_highlight, 0.8), fg = c.blue500 },
    ...
    -- Hop
    HopNextKey = { fg = c.blue500, bold = true },
    HopNextKey1 = { fg = c.blue500, bold = true },
    HopNextKey2 = { fg = c.blue700 },
    HopUnmatched = { fg = c.base01 },

    TSNodeKey = { fg = c.blue500, bold = true },
    TSNodeUnmatched = { fg = c.base01 },

    LeapMatch = { bg = c.blue500, fg = c.fg, bold = true },
    LeapLabelPrimary = { fg = c.blue500, bold = true },
    LeapLabelSecondary = { fg = c.grey, bold = true },
    LeapBackdrop = { fg = c.base01 },

    FlashBackdrop = { fg = c.base01 },
    FlashLabel = { bg = c.blue500, bold = true, fg = c.bg },

    LightspeedGreyWash = { fg = c.base01 },
    -- LightspeedCursor = { link = "Cursor" },
    LightspeedLabel = { fg = c.blue500, bold = true, underline = true },
    LightspeedLabelDistant = { fg = c.grey, bold = true, underline = true },
    LightspeedLabelDistantOverlapped = { fg = c.green100, underline = true },
    LightspeedLabelOverlapped = { fg = c.blue500, underline = true },
    LightspeedMaskedChar = { fg = c.orange },
    LightspeedOneCharMatch = { bg = c.blue500, fg = c.fg, bold = true },
    LightspeedPendingOpArea = { bg = c.blue500, fg = c.fg },
    LightspeedShortcut = { bg = c.blue500, fg = c.fg, bold = true, underline = true },
    -- LightspeedShortcutOverlapped = { link = "LightspeedShortcut" },
    -- LightspeedUniqueChar = { link = "LightspeedUnlabeledMatch" },
    LightspeedUnlabeledMatch = { fg = c.blue500, bold = true },

    -- Cmp
    CmpDocumentation = { fg = c.fg, bg = c.none },
    CmpDocumentationBorder = { fg = c.base02, bg = c.none },
    ...
    CmpItemKindCodeium = { fg = c.green100, bg = c.none },
    CmpItemKindCopilot = { fg = c.green100, bg = c.none },
    CmpItemKindTabNine = { fg = c.green100, bg = c.none },

    CmpItemKindKeyword = { fg = c.grey, bg = c.none },
    ...
    CmpItemKindClass = { fg = c.blue, bg = c.none },
    CmpItemKindInterface = { fg = c.blue, bg = c.none },
    CmpItemKindStruct = { fg = c.blue, bg = c.none },
    CmpItemKindEvent = { fg = c.blue, bg = c.none },
    CmpItemKindEnum = { fg = c.blue, bg = c.none },
    CmpItemKindUnit = { fg = c.blue, bg = c.none },

    CmpItemKindModule = { fg = c.yellow, bg = c.none },

    CmpItemKindProperty = { fg = c.grey, bg = c.none },
    CmpItemKindField = { fg = c.grey, bg = c.none },
    CmpItemKindTypeParameter = { fg = c.grey, bg = c.none },
    CmpItemKindEnumMember = { fg = c.grey, bg = c.none },
    CmpItemKindOperator = { fg = c.grey, bg = c.none },
    CmpItemKindSnippet = { fg = c.blue500, bg = c.none },
    ...
    NavicIconsProperty = { fg = c.grey, bg = c.bg_statusline },
    NavicIconsField = { fg = c.grey, bg = c.bg_statusline },
    ...
    NavicIconsVariable = { fg = c.blue, bg = c.bg_statusline },
    NavicIconsConstant = { fg = c.blue, bg = c.bg_statusline },
    ...
    NavicIconsKey = { fg = c.blue500, bg = c.bg_statusline },
    NavicIconsKeyword = { fg = c.blue500, bg = c.bg_statusline },
    NavicIconsNull = { fg = c.orange, bg = c.bg_statusline },
    NavicIconsEnumMember = { fg = c.grey, bg = c.bg_statusline },
    ...
    NavicIconsTypeParameter = { fg = c.grey, bg = c.bg_statusline },
    ...
    IndentBlanklineContextChar = { fg = c.blue300, nocombine = true },
    ...
    ScrollbarMiscHandle = { fg = c.blue500, bg = c.bg_highlight },
    ScrollbarMisc = { fg = c.blue500, bg = c.none },
    ...
    -- Lazy
    LazyProgressDone = { bold = true, fg = c.blue500 },
    ...
    NotifyTRACEBorder = { fg = util.darken(c.blue500, 0.3), bg = options.transparent and c.none or c.bg },
    --- Icons
    NotifyERRORIcon = { fg = c.error },
    NotifyWARNIcon = { fg = c.warning },
    NotifyINFOIcon = { fg = c.info },
    NotifyDEBUGIcon = { fg = c.base01 },
    NotifyTRACEIcon = { fg = c.blue500 },
    --- Title
    NotifyERRORTitle = { fg = c.error },
    NotifyWARNTitle = { fg = c.warning },
    NotifyINFOTitle = { fg = c.info },
    NotifyDEBUGTitle = { fg = c.base01 },
    NotifyTRACETitle = { fg = c.blue500 },
    --- Body
    ...
    MiniDiffSignAdd = { fg = c.blue500 },
    MiniDiffSignChange = { fg = c.blue700 },
    ...
    MiniIndentscopeSymbolOff = { fg = c.orange900, nocombine = true },

    MiniJump = { bg = c.blue500, fg = c.base4 },

    MiniJump2dDim = { fg = c.base01 },
    MiniJump2dSpot = { fg = c.blue500, bold = true, nocombine = true },
    MiniJump2dSpotAhead = { fg = c.green100, bg = c.black, nocombine = true },
    MiniJump2dSpotUnique = { fg = c.blue700, bold = true, nocombine = true },
    ...
    MiniStarterSection = { fg = c.blue500 },
    ...
    MiniStatuslineModeOther = { fg = c.black, bg = c.green100, bold = true },
    MiniStatuslineModeReplace = { fg = c.black, bg = c.red, bold = true },
    MiniStatuslineModeVisual = { fg = c.black, bg = c.blue, bold = true },

    MiniSurround = { bg = c.blue, fg = c.black },

    MiniTablineCurrent = { fg = c.fg, bg = c.base02, bold = true },
    MiniTablineFill = { bg = c.black },
    MiniTablineHidden = { fg = c.blue500, bg = c.bg_statusline },
    MiniTablineModifiedCurrent = { fg = c.base02, bg = c.fg, bold = true },
    MiniTablineModifiedHidden = { fg = c.bg_statusline, bg = c.blue500 },
    ...
    TreesitterContext = { bg = c.blue900 },
    Hlargs = { fg = c.yellow },
  }
